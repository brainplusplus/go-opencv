#!/bin/bash
# build-goopencv-linux-arm64.sh — Build goopencv.so for Linux arm64 (aarch64)
# Uses debian-bookworm-aarch64 SDK from opencv-mobile
# Requires: g++, wget, unzip
# Usage: bash build-tools/build-goopencv-linux-arm64.sh
...
OPENCV_PKG="opencv-mobile-${OPENCV_VERSION}-debian-bookworm-aarch64"
